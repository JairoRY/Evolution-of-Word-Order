...
int main() {
    ...
    for (const auto& entry : fs::directory_iterator(dirPath)) {
        ...
        while (getline(infile, line)) {
            buffer += line + " ";
            if (line.find("))") != string::npos) {  // crude end of sentence
